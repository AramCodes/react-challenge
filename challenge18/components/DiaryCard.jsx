...
export default function DiaryCard(props) {
    ...
    const emotionElements = getElements(props.day.emotions)
    const activityElements = getElements(props.day.activities)
        ...
        <div className="diary-card">
            ...
            <div className="rating-container">
                <div className="rating-outline">
                    <p><span className="bold">Rating:</span> {props.day.rating}<span className="percent">%</span></p>
                    <div className={`rating-fill ${getClasses()}`}
                        style={{width: `${props.day.rating}%`}}
                    >
                    </div>
                </div>
