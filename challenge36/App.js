...
            ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯    
     ...
     2. If mouseDown is true and if the user's cursor enters any of the "pixel" divs, that div's 
        corresponding pixel data object in the pixels state array should have its "filled" property 
        set to true if "wantsToDraw" is true and set to false if "wantsToDraw" is false. In other words, 
        if mouseDown === true && the user's cursor enters the div corresponding to pixel[n],
...
            ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
     ...
     3. All other properties of this and every other pixel data object should be preserved. In 
        other words, only the "filled" property of the particular pixel data object being targeted should be 
        altered. Everything else should stay the same. 
