...
export default function App() {
	...
	function handleClick(event) {
		...
		setPassedEmojis(prevPassedEmojis => [...prevPassedEmojis, ...unClickedEmojis])
...
/* Challenge
	...
	The handleClick function above needs to be completed for the app to work. The function should do three things 
	when it is invoked by the user clicking on one of the buttons (lines 84 to 92): 
		...
		4. If you complete these tasks correctly, the emojis should be sent to their respective 
		   columns when you click on one of them, and the counter at the top should increment until you reach 10, 
		   at which point the test results will be revealed. 
