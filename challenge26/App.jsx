...
/* Challenge
    ...
    The four buttons for each article aren't working. Your task is to set them up as follows: 
        ...
        1. You should add a single onClick event handler to the "articles-container" div. No other     
		event handlers should be added to the project. The event handler should use the buttons' 
