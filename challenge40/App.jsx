...
/* Challenge 
    ...
    The app's core gameplay components are already in place, but the start button and timer are unfinished. 
    Your task is to finish setting them up to get the game working! 
...
*/
    ...
    const effectClass = timerRunning? "fade-out" : "fade-in" || timeLeft === 0 ? "fade-in" : "fade-out"
    ...
    return (
        <div>
            ...
            <button 
            onClick={startGame}
            className={`play-button ${effectClass} `}
